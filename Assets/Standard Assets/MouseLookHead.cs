...
using UnityEngine.VR;
	...
	Vector3 dist;
		...
		if (VRSettings.enabled == false && _isLocalPlayer){
            ...
            if(smooth)
            {
                charactr.localRotation = Quaternion.Slerp (charactr.localRotation, m_CharacterTargetRot,
            ...
            {
                charactr.localRotation = m_CharacterTargetRot;
				Vector3 lookPos=transform.position+m_CameraTargetRot*dist;
				lookPos.z=0;
